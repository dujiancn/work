...
where pto.go_back_date>="2016-07-01" and pto.go_back_date<"2016-08-01";
...
where poa.type = 'retail' and pto.go_back_date >= '2016-07-01' and pto.go_back_date < '2016-08-01';
